...
public class BallController : MonoBehaviour
{
	...
	public event EventHandler OnSuccessAdd;
	...
	void Start ()
	{
		...
		ShotCount++;
		this.OnSuccessAdd += BallController_OnSuccessAdd;
	}

	private void BallController_OnSuccessAdd(object sender, EventArgs e)
	{
	...
	private void OnTriggerEnter(Collider other)
	{
		if (other.name == "TriggerTop")
		{
			...
			if (hasTriggeredTop  && !hasBeenScored)
			{
				...
				OnSuccessAdd(this, EventArgs.Empty);
			}
			hasBeenScored = true;
		}
	}
